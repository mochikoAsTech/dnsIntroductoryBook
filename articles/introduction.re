...
「DNS超入門」の筆者、mochikoAsTechです。

皆さん、DNSは好きですか？筆者はDNSが大好きです！なぜか分からないけど、DNS絡みの障害が起きたニュースを見てはわくわくして勝手に調査してしまうし、DNSのことで困っている人がいると解説したくてうずうずします。
...
「DNS超入門」は、そんなDNSが好きで仕方ない著者が、普段開発や運用をしているエンジニアに「DNSのことを知っておくと自分でなんとか出来る範囲が広がるよ」と伝えたくて書いた一冊です。
